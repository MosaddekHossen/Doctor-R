  ...
  return (
    <>
      <div className="bg-[#07332F]">
        <div className="lg:h-[calc(100vh-160px)] h-[calc(100vh-128px)] text-white max-w-custom mx-auto flex flex-col lg:flex-row items-center">
          <div className="flex-1">
            <div className="relative px-7 md:px-0">
              <h1 className="md:text-[75px] text-[30px] lg:leading-[90px] text-center lg:tracking-[-3px] md:text-left font-semibold text-[#F3F3F3]">
            ...
            <p className="text-[#F3F3F3] md:text-base px-7 md:px-0 text-sm text-center md:text-left py-2 md:py-4">
            ...
            <div className="text-[#F3F3F3] text-center md:text-left">
              <button className="bg-[#F7A582] py-3 px-8 font-bold font-source lg:mt-7 rounded-lg">
                All Service
              </button>
            </div>
          </div>
          <div className="flex-1 relative">
            ...
            <img
              className="h-full w-full opacity-100 relative object-cover p-12 lg:p-9"
